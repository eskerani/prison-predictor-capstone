# Studio Charter: Investigating Social Factors as Predictors of Incarceration Rates (better name pending)
...
|-----------------------------|--------------|---------|
| Peer PO files a **Studio Brief** (commits to `studio/briefs/...`, links in `#<project>-studio`) | Owner team | Acknowledge or react in `#<project>-studio` within 24 hours, with a first-pass adopt / defer / decline call for each item |
