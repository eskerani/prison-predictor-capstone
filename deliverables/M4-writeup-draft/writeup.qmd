...
Of the decades included in analysis, the multi-variable model generated the best predictions for 2000 onwward (with RMSEs of 30.41 and 33.5 for the 2000s and 2010s, respectively) and performed markedly worse on data from the 1980s (which had an RMSE of 74.48) and 90s (RMSE of 60.51). With respect to geography, the model's accuracy varied widely: the East South Central, West North Central, Pacific, and South Atlantic census regions all had RMSEs of under 50, while other regions ranged from 50 to 71.53. However, it must be noted that predictions were not generated based on even numbers of instances of states from each region in the testing data; due to stratification by year when creating the train-test split, the state distributions were shuffled and thus regional appearences in testing data vary widely from 27-93.
